...
time build/X86/gem5.opt \
 --stats-file=/media/tanawin/tanawin1701d/Project/Intern/InternGem5/m5out/testFullS/frfcfsSw16_2.txt \
 --json-config=/media/tanawin/tanawin1701d/Project/Intern/InternGem5/m5out/testFullS/frfcfsSw16_2.json \
 /media/tanawin/tanawin1701d/Project/Intern/InternGem5/configs/example/myFs.py \
 --fast-forward=8000000000000000000\
 --frame-capture\
 --disk-image=/media/tanawin/tanawin1701d/Project/Intern/gem5e/disk-images/db/parsec_db_switch-image/parsec_db_switch \
 --script=/media/tanawin/tanawin1701d/Project/Intern/InternGem5/configs/example/myScript/mulbenchSwitch.rcS \
 --kernel=/media/tanawin/tanawin1701d/Project/Intern/InternGem5/fullSysSup/vmlinux-4.19.83 \
 --memAccessDebugStat=/media/tanawin/tanawin1701d/Project/Intern/InternGem5/m5out/testFullS/frfcfsSw16mdb_2.txt \
 --mem-size=8192MB \
 -n 8 \
 --cpu-type=DerivO3CPU \
 --l1d_size=16kB \
